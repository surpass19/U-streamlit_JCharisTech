...
face_cascade_path = 'frecog/haarcascade_frontalface_default.xml'
eye_cascade_path = 'frecog/haarcascade_eye.xml'
smile_cascade_path = 'frecog/haarcascade_smile.xml'
